...
public interface UserApi {
     ...
     * @return successful operation (status code 200)
     *         or Request error (status code 400)
     *         or User not found (status code 404)
     */
    @Operation(
    ...
    ResponseEntity<List<UserDTO>> listUsers(
        @Parameter(name = "username", description = "username", in = ParameterIn.HEADER) @RequestHeader(value = "username", required = false) String username,
